...
covid_font = pygame.font.SysFont('freesansbold.ttf', 30, bold=True, italic=True)

# running status variable
running = True

# creating a 1080*720 screen
screen = pygame.display.set_mode((1080, 720))

# title
pygame.display.set_caption('Covid info Tracker @Gaurav_kumar')
...
while running:
    ...
    # printing world data on 1080*720 screen
